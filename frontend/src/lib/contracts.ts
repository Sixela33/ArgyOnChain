...
export const TokenFactoryABI = TokenFactoryArtifact.abi as unknown as Abi
export const TokenABI = TokenArtifact.abi as unknown as Abi
export const USDCABI = USDCArtifact.abi as unknown as Abi
export const ClaimIssuerManagerABI = ClaimIssuerManagerArtifact.abi as unknown as Abi
